...
! function (a) {
    ...
    a.summernote = a.summernote || {
        ...
        "en-US": {
            ...
            image: {
                image: "تصویر",
                insert: "قراردادن تصویر",
                resizeFull: "تمام صفحه",
                resizeHalf: "نصف",
                resizeQuarter: "یک چهارم",
                floatLeft: "شناور به چپ",
                floatRight: "شناور به راست",
                floatNone: "بدون شناور",
                shapeRounded: "حالت : دور گرد",
                shapeCircle: "حالت : دایره ای",
                shapeThumbnail: "عکس کوچک",
                shapeNone: "بدون حالت",
                dragImageHere: "کشیدن متن یا تصویر به اینجا",
                dropImage: "رها کردن تصویر یا متن در اینجا",
                selectFromFiles: "انتخاب از فایل ها",
                maximumFileSize: "حداکثر سایز عکس",
                maximumFileSizeError: "حداکثر حجم فایل",
                url: "URL تصویر",
                remove: "حذف تصویر"
            },
            video: {
            ...
            link: {
                ...
                unlink: "حذف لینک",
                edit: "ویرایش",
                textToDisplay: "نمایش به متن",
                url: "عقم",
                openInNewWindow: "باز کردن در برگه جدید"
            },
            table: {
                table: "جدول",
            ...
            paragraph: {
                paragraph: "پاراگراف",
                outdent: "شناور کردن به چپ",
                indent: "شناور کردن به راست",
                left: "چپ چین",
                center: "وسط چین",
                right: "راست چین",
                justify: "همسازی از طرفین"
            },
            color: {
                recent: "رنگ فعلی",
                more: "رنگ بیشتر",
                ...
                foreground: "رنگ متن",
                transparent: "شفاف",
                setTransparent: "قراردادن رنگ والد",
                reset: "بازگردانی",
                resetToDefault: "بازگردانی به حالت پیش فرض"
            },
            shortcut: {
                shortcuts: "کلید ترکیبی",
                close: "بستن",
                textFormatting: "قالب بندی متن",
                action: "عملیات",
                paragraphFormatting: "قالب بندی پاراگراف",
                documentStyle: "استایل سند",
                extraKeys: "کلیدهای اضافی"
            },
            help: {
                insertParagraph: "قرار دادن پاراگراف",
                undo: "رفتن به حرکت قبل",
                redo: "رفتن به حرکت بعد",
                tab: "زبانه",
                untab: "حذف زبانه",
                bold: "قراردادن استایل تو پُر",
                italic: "قراردادن استایل کج",
                underline: "قراردادن خط زیر متن",
                strikethrough: "قراردادن استایل خط خورده",
                removeFormat: "پاک کردن استایل ها",
                justifyLeft: "چپ چین کردن متن",
                justifyCenter: "وسط چین کردن متن",
                justifyRight: "راست چین کردن متن",
                justifyFull: "همسازی متن از طرفین",
                insertUnorderedList: "لیست غیرترتیبی",
                ...
                formatH5: "استایل h5",
                formatH6: "استایل h6",
                insertHorizontalRule: "قرار دادن خط افقی",
                "linkDialog.show": "قرار دادن لینک روی مطلب"
            },
            history: {
                undo: "رفتن به حالت قبلی",
                redo: "رفتن به حالت بعدی"
            },
            specialChar: {
                specialChar: "کاراکتر های خاص",
                select: "انتخاب کاراکتر های خاص"
            }
        }
    });
    var K = function () {
