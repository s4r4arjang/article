! function () {
    ...
    h("a", tinymce.util.Tools.resolve), g("6", ["a"], function (a) {
    ...
    }), g("2", ["d", "e", "8", "6", "b"], function (a, b, c, d, e) {
        var f = d.each,
            g = e.getSpanVal;
        return function (h) {
            function i() {
        ...
        function j(f) {
            ...
            function i(a, b) {
                var c, d, e, g;
                for (e = '<table id="__mce"><tbody>', c = 0; c < b; c++) {
                    for (e += "<tr>", d = 0; d < a; d++) e += "<td>" + (h.ie && h.ie < 10 ? "&nbsp;" : "<br>") + "</td>";
                    e += "</tr>"
                }
            ...
            function p(a, b, c) {
                var d, e, g, h, i, j = c.getEl().getElementsByTagName("table")[0],
                    k = c.isRtl() || "tl-tr" == c.parent().rel;
                for (j.nextSibling.innerHTML = a + 1 + " x " + (b + 1), k && (a = 9 - a), e = 0; e < 10; e++)
                    for (d = 0; d < 10; d++) h = j.rows[e].childNodes[d].firstChild, i = (k ? d >= a : d <= a) && e <= b, f.dom.toggleClass(h, "mce-active", i), i && (g = h);
                return g.parentNode
            }
            ...
            var v, w, x = this,
                y = new d(f);
            !f.settings.object_resizing || f.settings.table_resize_bars === !1 || f.settings.object_resizing !== !0 && "table" !== f.settings.object_resizing || (w = e(f)), f.settings.table_grid === !1 ? f.addMenuItem("inserttable", {
                text: "جدول",
                icon: "table",
                context: "table",
                onclick: y.table
                ...
                context: "table",
                menu: [{
                    text: "اضافه کردن ردیف به قبل",
                    onclick: g("mceTableInsertRowBefore"),
                    onPostRender: m
                }, {
                    text: "اضافه کردن ردیف به بعد",
                    onclick: g("mceTableInsertRowAfter"),
                    onPostRender: m
                }, {
                    text: "حذف ردیف",
                    ...
                    text: "جایگذاری ردیف در قبل",
                    onclick: g("mceTablePasteRowBefore"),
                    onPostRender: m
                }, {
                    text: "جایگذاری ردیف در بعد",
                    onclick: g("mceTablePasteRowAfter"),
                    onPostRender: m
                }]
                ...
                context: "table",
                menu: [{
                    text: "اضافه کردن ستون به قبل",
                    onclick: g("mceTableInsertColBefore"),
                    onPostRender: m
                }, {
                    text: "اضافه کردن ستون به بعد",
                    onclick: g("mceTableInsertColAfter"),
                    onPostRender: m
                }, {
                    text: "حذف ستون",
            ...
            k("inserttable tableprops deletetable | cell row column".split(" "), function (a) {
            ...
            }), x.quirks = new b(f), f.on("Init", function () {
                ...
                mceTableMergeCells: function (a) {
                    var b;
                    b = f.dom.getParent(f.selection.getStart(), "th,td"), f.dom.select("td[data-mce-selected],th[data-mce-selected]").length ? a.merge() : y.merge(a, b)
                },
            ...
            }), x.insertTable = i, x.setClipboardRows = u, x.getClipboardRows = t
        }
        var k = f.each;
        return i.add("table", j),
            function () {}
    }), d("0")()
}();