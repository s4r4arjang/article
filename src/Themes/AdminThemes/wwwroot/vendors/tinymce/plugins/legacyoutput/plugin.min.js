! function () {
    ...
    h("3", tinymce.util.Tools.resolve), g("1", ["3"], function (a) {
        ...
        return a.add("legacyoutput", function (a, c, d) {
                a.settings.inline_styles = !1, a.on("init", function () {
                    ...
                    }), e.getElementRule("font") || e.addValidElements("font[face|size|color|style]"), b.each(c.split(","), function (a) {
                    ...
                    return a.$.each(d.split(" "), function (a, c) {
                        var d = c,
                            e = c,
                            f = c.split("=");
                        f.length > 1 && (d = f[0], e = f[1]), b.push({
                            text: d,
                            value: e
                        })
                    }), {
